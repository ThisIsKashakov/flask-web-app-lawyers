...
# Remove MAX_FILE_SIZE constant definition

# Remove ALLOWED_EXTENSIONS and allowed_file function definitions as they're now in utils.py
...
def upload_file(case_id):
    try:
        ...
        # Create database entry with file size
        new_file = CaseFile(
